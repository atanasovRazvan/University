...
const tasks = Array.from(Array(30).keys()).map(id => ({
  id,
  text: `task ${id}`,
  version: 1,
  tag: `tag${id % 3}`
...
module.exports = __webpack_require__(/*! C:\Users\Razvan\Desktop\Facultate\Anul_3\Mobile\exam_server\src/index.js */"./src/index.js");
